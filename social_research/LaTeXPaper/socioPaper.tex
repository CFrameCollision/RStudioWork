...
\begin{figure*}
  \caption{Log Odd Estimates of Educational Attainment with 95\% Confidence Intervals.}
  \label{DW:LogOdds}
  \includegraphics[width=\textwidth]{paperLogOdds.png}
\end{figure*}

\begin{figure*}
  \caption{Cutpoint Estimates of Educational Attainment with 95\% Confidence Intervals.}
  \label{DW:CutPoints}
  \includegraphics[width=\textwidth]{paperCutpoints.png}
\end{figure*}
...
% Tables created by stargazer v.5.2.3 by Marek Hlavac, Social Policy Institute. E-mail: marek.hlavac at gmail.com
