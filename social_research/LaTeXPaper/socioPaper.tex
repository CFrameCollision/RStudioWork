...
As previously described, the sample used was the NLSY97 conducted by the US Bureau of Labor Statistics (BLS) (2024)\nocite{noauthor_nlsy97_nodate}. This is a nationally representative sample carried out every year pre-2011 and every two years thereafter, with selection finalized in 1997 and round 1 of questions carried out in 1998. This database was chosen due to the large sample size (\textit{n} = \textasciitilde8,000 respondents), robust and comprehensive question selection, representative nature, and ease of access.
...
In total, 6701 individuals were included in the analysis from a possible 8,984.
