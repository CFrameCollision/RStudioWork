...
\begin{enumerate}[label=H\textsubscript{\arabic*}:]
     \item Higher levels of parental education and identifying as White will independently correlate with higher educational milestones completed by ages 33--37.
     ...
     \item Specifically, it is hypothesized that at higher levels of parental education, the attainment gap between White respondents and Black or Hispanic respondents will persist or widen, suggesting that systemic racial discrimination attenuates the social capital typically provided by high parental education.
\end{enumerate}
...
Lastly, the sample size for individuals of mixed race is excessively small (\textit{n}=64) after selecting valid cases and prior to casewise deletion or imputation of invalid/missing parent HGC answers. This high standard error and low prediction power. Future studies should aim to encapsulate a greater number of respondents within this demographic, as it is underexplored.

\section{Results}
\subsection{Descriptive Statistics}

In total, 6701 individuals were included in the analysis from a possible 8,984. Table \ref{tab:Descriptive Statistics} provides a breakdown, by race, of educational attainment of all respondents.

\begin{table}
     \caption{Number of respondents and highest grade completed by race. *See}
     \centering
     \begin{tabular}{ccccc}
          \hline
...
Additionally, GED and HS are interpreted as discrete ordinal categories, with GED placed below HS. While societally they may be seen as different, practically, they hold the same functional distinction. On the other hand, a PhD and a professional degree were collapsed into a single level (level 7). See \textit{methods}.
